...
<html lang="en">
    <head>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=UA-128360639-1"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag('js', new Date());

          gtag('config', 'UA-128360639-1');
        </script>
        ...
        <section class="section-features js--section-features" id="features">
            ...
            <div class="row js--wp-1">
                <div class="col span-1-of-4 box">
                    <ion-icon name="ios-infinite" class="icon-big"></ion-icon>
                ...
                <div class="col span-1-of-4 box">
                    <ion-icon name="ios-stopwatch" class="icon-big"></ion-icon>
                ...
                <div class="col span-1-of-4 box">
                    <ion-icon name="ios-nutrition" class="icon-big"></ion-icon>
                    <h3>100% organic</h3>
                    <p>
                ...
                <div class="col span-1-of-4 box">
                    <ion-icon name="ios-cart" class="icon-big"></ion-icon>
            ...
            <div class="row">
                <form method="post" action="mailer.php" class="contact-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col span-2-of-3" id="contact-form-button">
            ...
            <div class="row">
                ...
                <div class="col span-1-of-2">
                    <ul class="social-links">
                        ...
                        <li><a href="#"><ion-icon name="logo-googleplus" id="google-plus"></ion-icon></a></li>
